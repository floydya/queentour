...
--
-- Name: core_aboutsettings; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE core_aboutsettings (
    id integer NOT NULL,
    image character varying(100) NOT NULL,
    title character varying(144) NOT NULL,
    column1_image character varying(100) NOT NULL,
    column1_title character varying(40) NOT NULL,
    column1_body text NOT NULL,
    column2_image character varying(100) NOT NULL,
    column2_title character varying(40) NOT NULL,
    column2_body text NOT NULL,
    column3_image character varying(100) NOT NULL,
    column3_title character varying(40) NOT NULL,
    column3_body text NOT NULL,
    column4_image character varying(100) NOT NULL,
    column4_title character varying(40) NOT NULL,
    column4_body text NOT NULL,
    body text NOT NULL
);


ALTER TABLE core_aboutsettings OWNER TO postgres;

--
-- Name: core_aboutsettings_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE core_aboutsettings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE core_aboutsettings_id_seq OWNER TO postgres;

--
-- Name: core_aboutsettings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE core_aboutsettings_id_seq OWNED BY core_aboutsettings.id;
...
CREATE TABLE core_comment (
    ...
    CONSTRAINT core_comment_type_check CHECK ((type >= 0))
);
...
--
-- Name: core_documentssettings; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE core_documentssettings (
    id integer NOT NULL,
...
ALTER TABLE core_documentssettings OWNER TO postgres;

--
-- Name: core_documentssettings_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE core_documentssettings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE core_documentssettings_id_seq OWNER TO postgres;

--
-- Name: core_documentssettings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE core_documentssettings_id_seq OWNED BY core_documentssettings.id;
...
--
-- Name: core_aboutsettings id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY core_aboutsettings ALTER COLUMN id SET DEFAULT nextval('core_aboutsettings_id_seq'::regclass);
...
--
-- Name: core_documentssettings id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY core_documentssettings ALTER COLUMN id SET DEFAULT nextval('core_documentssettings_id_seq'::regclass);
...
141	Can add about settings	37	add_aboutsettings
142	Can change about settings	37	change_aboutsettings
143	Can delete about settings	37	delete_aboutsettings
144	Can view about settings	37	view_aboutsettings
145	Can add documents settings	38	add_documentssettings
146	Can change documents settings	38	change_documentssettings
147	Can delete documents settings	38	delete_documentssettings
148	Can view documents settings	38	view_documentssettings
\.
...
1	pbkdf2_sha256$120000$WCSW3EErb1gX$7OP77D312a49vnrCwvygBN9pbYj2UGvQxSe0YG5SYa4=	2018-09-04 12:11:10.961645+00	t	admin	adminqwerty12345		xfloydya@gmail.com	t	t	2018-09-02 07:16:25+00
\.
...
28	article-19	Article 19	2018-09-03 12:59:38.832692+00	<p>Body 19</p>	5	0	3
19	article-10	Article 10	2018-09-03 12:59:38.522365+00	<p>Body 10</p>	1	0	4
26	article-17	Article 17	2018-09-03 12:59:38.785346+00	<p>Body 17</p>	2	0	2
27	article-18	Article 18	2018-09-03 12:59:38.809961+00	<p>Body 18</p>	9	0	3
20	article-11	Article 11	2018-09-03 12:59:38.559123+00	<p>Body 11</p>	23	0	5
25	article-16	Article 16	2018-09-03 12:59:38.761974+00	<p>Body 16</p>	2	0	1
\.
...
--
-- Data for Name: core_aboutsettings; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY core_aboutsettings (id, image, title, column1_image, column1_title, column1_body, column2_image, column2_title, column2_body, column3_image, column3_title, column3_body, column4_image, column4_title, column4_body, body) FROM stdin;
1	images/company2.png	QUEEN TOUR VOYAGE - это:	images/comp3.png	Широкий выбор туров	<p>Мы сотрудничаем с ведущими туроператорами, а значит &mdash; Вы получите лучшие предложения, согласно Вашим потребностям и желаниям.</p>	images/comp3_pBb7tz5.png	Широкий выбор	<p>Мы сотрудничаем с ведущими туроператорами, а значит &mdash; Вы получите лучшие предложения, согласно Вашим потребностям и желаниям.</p>	images/comp3_fjk6Q3q.png	Высокий профессионализм	<p>Мы сотрудничаем с ведущими туроператорами, а значит &mdash; Вы получите лучшие предложения, согласно Вашим потребностям и желаниям. Мы сотрудничаем с ведущими туроператорами, а значит &mdash; Вы получите лучшие предложения, согласно Вашим потребностям и желаниям.</p>	images/comp3_d5UvNTW.png	Высокий профессионализм сотрудников	<p>Мы сотрудничаем с ведущими туроператорами, а значит &mdash; Вы получите лучшие предложения, согласно Вашим потребностям и желаниям. Мы сотрудничаем с ведущими туроператорами, а значит</p>	<p>Lorem ipsum</p>\r\n\r\n<p>&laquo;QUEEN TOUR VOYAGE&raquo; - это туристическая компания для тех, кто любит изысканный королевский отдых.</p>\r\n\r\n<p>Путешествуйте на яхтах стоимостью в миллионы долларов, проживайте в загадочных и древних дворцах, отправляйтесь на моря и океаны, где ранее ступала нога только очень богатых и знатных вельмож, или же отдайте предпочтение экстремальному отдыху в диких условиях с коренным населением &mdash; аборигенами. Туристическая компания QUEEN TOUR VOYAGE осуществит любые Ваши желания.</p>\r\n\r\n<p><strong>QUEEN TOUR VOYAGE &mdash; это нечто большее, нежели просто путешествия высокого уровня.&nbsp;</strong>К каждому нашему клиенту мы ищем свой особый подход, чтобы понять его истинные желания и удовлетворить их в полном объеме. Наша задача &mdash; организовать для Вас сплошной праздник, длинною в отпуск, а не любой ценой продать Вам путевку.</p>\r\n\r\n<p>Наша особенность &mdash; это тщательное планирование Вашего путешествия. Мы говорим твердое &laquo;НЕТ&raquo; стереотипам и подготовим для Вас тур по удивительным местам. Пока другие туристы будут ходить тропами, где ежедневно проходят сотни таких же путешественников со всего мира, Вы сможете посетить самые изысканные места: разгадаете тайны древних восточных цивилизаций, ощутите дух Средневековой Европы, отдохнёте на мягких песчаных пляжах или почувствуете дух авантюризма и подниметесь на крутую гору или вершину. Мы сделаем все, чтобы Вы почувствовали себя VIP-персоной.</p>\r\n\r\n<p>Мы сделали это для вас:</p>\r\n\r\n<ul>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n\t<li>подготовим для Вас незабываемое путешествие в любую страну мира;</li>\r\n</ul>\r\n\r\n<p>С QUEEN TOUR VOYAGE Вы почувствуете себя королевской особой, а мы, в свою очередь, осуществим Ваши мечты. Путешествуйте!</p>
\.
...
COPY core_comment (id, name, age, description, datetime, youtube, hotel_id, comment, image, type) FROM stdin;
...
4	Иван Иванов	29	Менеджер	2018-09-01	https://www.youtube.com/embed/tgbNymZ7vqY	2			3
5	Иван Николаев	25	преподаватель	2018-09-04	\N	8		images/hot-4.png	2
\.


--
-- Data for Name: core_documentssettings; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY core_documentssettings (id, passport, visa) FROM stdin;
1	<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<table>\r\n\t<tbody>\r\n\t\t<tr>\r\n\t\t\t<td>Наименование услуг</td>\r\n\t\t\t<td>Срок оформления (раб.дней)</td>\r\n\t\t\t<td>Стоимость (грн.)</td>\r\n\t\t\t<td>Необходимые документы</td>\r\n\t\t</tr>\r\n\t</tbody>\r\n</table>\r\n\r\n<table>\r\n\t<tbody>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>БИОМЕТРИЧЕСКИЙ</p>\r\n\r\n\t\t\t<p>заграничный паспорт</p>\r\n\r\n\t\t\t<p>Киев, Киевская обл., другие области Украины</p>\r\n\t\t\t</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Сроки</p>\r\n\t\t\t</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Новый</p>\r\n\t\t\t</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Второй</p>\r\n\t\t\t</td>\r\n\t\t\t<td rowspan="6">\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p><strong>Lorem&nbsp;</strong>ipsum dolor sit amet, consectetur adipisicing elit. Praesentium, pariatur! Nostrum temporibus nesciunt praesentium voluptates magni vel distinctio soluta ea. Praesentium, pariatur! Nostrum temporibus nesciunt praesentium voluptates magni vel distinctio soluta ea.</p>\r\n\r\n\t\t\t<p><strong>Lorem&nbsp;</strong>ipsum dolor sit amet, consectetur adipisicing elit. Praesentium, pariatur! Nostrum</p>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>Киев</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>Киев</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>Срочный</p>\r\n\t\t\t</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>Суперрочный</p>\r\n\t\t\t</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>Новая услуга</p>\r\n\t\t\t</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>ДЕТСКИЙ</p>\r\n\r\n\t\t\t<p>заграничный паспорт</p>\r\n\r\n\t\t\t<p>Киев, Киевская обл., другие области Украины</p>\r\n\t\t\t</td>\r\n\t\t\t<td>&nbsp;</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Новый</p>\r\n\t\t\t</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Второй</p>\r\n\t\t\t</td>\r\n\t\t\t<td rowspan="5">\r\n\t\t\t<p>До 12 лет</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>После 12 лет</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>1. Lorem ipsum dolor</p>\r\n\r\n\t\t\t<p>2. Lorem ipsum dolor sit amet</p>\r\n\r\n\t\t\t<p>РАСКРЫТЬ</p>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>Киев</td>\r\n\t\t\t<td>БИО</td>\r\n\t\t\t<td>1100</td>\r\n\t\t\t<td>1200</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>Киев</td>\r\n\t\t\t<td>БИО</td>\r\n\t\t\t<td>1100</td>\r\n\t\t\t<td>1200</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>Срочный</p>\r\n\t\t\t</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>Суперрочный</p>\r\n\t\t\t</td>\r\n\t\t\t<td>1 месяц</td>\r\n\t\t\t<td>1300</td>\r\n\t\t\t<td>1300</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>Вклеивание ребенка в</p>\r\n\r\n\t\t\t<p>заграничный паспорт родителей</p>\r\n\r\n\t\t\t<p>Киев, Киевская обл., другие области Украины</p>\r\n\t\t\t</td>\r\n\t\t\t<td>&nbsp;</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Новый</p>\r\n\t\t\t</td>\r\n\t\t\t<td>\r\n\t\t\t<p>Второй</p>\r\n\t\t\t</td>\r\n\t\t\t<td>\r\n\t\t\t<p>1)&nbsp;<strong>2 матовые&nbsp;</strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>\r\n\r\n\t\t\t<p>2) Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga, saepe!</p>\r\n\r\n\t\t\t<p>3) Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>\r\n\r\n\t\t\t<p>4) Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga, saepe!</p>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t</tbody>\r\n</table>	<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<p>Оформление БИОМЕТРИЧЕСКОГО загранпаспорта для жителей Киева, Киевской обл., других областей Украины</p>\r\n\r\n<table>\r\n\t<tbody>\r\n\t\t<tr>\r\n\t\t\t<td>СТРАНА</td>\r\n\t\t\t<td>СТОИМОСТЬ</td>\r\n\t\t\t<td>ТИП ВИЗЫ</td>\r\n\t\t\t<td>СРОК ОФОРМЛЕНИЯ</td>\r\n\t\t\t<td>НЕОБХОДИМЫЕ ДОКУМЕНТЫ</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>Греция</td>\r\n\t\t\t<td>460</td>\r\n\t\t\t<td>\r\n\t\t\t<p>180</p>\r\n\r\n\t\t\t<p>360</p>\r\n\t\t\t</td>\r\n\t\t\t<td>срок оформления</td>\r\n\t\t\t<td>необходимые документы</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td rowspan="3">Литва</td>\r\n\t\t\t<td>320 езженый</td>\r\n\t\t\t<td>пол года</td>\r\n\t\t\t<td rowspan="3">10 дней</td>\r\n\t\t\t<td rowspan="3">минимальный пакет документов</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>340 чистый</td>\r\n\t\t\t<td>пол года</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>\r\n\t\t\t<p>420 езженый</p>\r\n\r\n\t\t\t<p>440 чистый</p>\r\n\t\t\t</td>\r\n\t\t\t<td>год</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td rowspan="2">Испания</td>\r\n\t\t\t<td>450</td>\r\n\t\t\t<td>90/180</td>\r\n\t\t\t<td rowspan="2">10 дней</td>\r\n\t\t\t<td rowspan="2">минимальный пакет документов</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>450</td>\r\n\t\t\t<td>180</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td rowspan="2">Венгрия</td>\r\n\t\t\t<td>450</td>\r\n\t\t\t<td>90/180</td>\r\n\t\t\t<td rowspan="2">10 дней</td>\r\n\t\t\t<td rowspan="2">минимальный пакет документов</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>450</td>\r\n\t\t\t<td>180</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td rowspan="2">Словакия</td>\r\n\t\t\t<td>340</td>\r\n\t\t\t<td>\r\n\t\t\t<p>пол года</p>\r\n\r\n\t\t\t<p>год</p>\r\n\t\t\t</td>\r\n\t\t\t<td rowspan="2">10 дней</td>\r\n\t\t\t<td rowspan="2">минимальный пакет документов</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>123</td>\r\n\t\t\t<td>180</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td rowspan="2">Польша</td>\r\n\t\t\t<td>450</td>\r\n\t\t\t<td>90/180</td>\r\n\t\t\t<td rowspan="2">10 дней</td>\r\n\t\t\t<td rowspan="2">минимальный пакет документов</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>450</td>\r\n\t\t\t<td>180</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td>Италия</td>\r\n\t\t\t<td>Стоимость</td>\r\n\t\t\t<td>7</td>\r\n\t\t\t<td>срок оформления</td>\r\n\t\t\t<td>необходимые документы</td>\r\n\t\t</tr>\r\n\t</tbody>\r\n</table>
\.
...
COPY core_image (id, image, object_id, content_type_id, link) FROM stdin;
8	images/city-main.png	1	24	\N
9	images/h1.png	1	22	\N
10	images/news-1.png	1	19	\N
11	images/news-2.png	2	19	\N
12	images/news-3.png	3	19	\N
13	images/news-4.png	4	19	\N
7	images/big-main.png	1	21	\N
14	images/blog_1-1.png	1	21	\N
15	images/city-main_t4Wsmwx.png	1	21	\N
16	images/hotels1.png	1	21	\N
17	images/reg-main.png	1	21	\N
4	images/pegas.png	1	15	http://pegast.com.ua/
21	images/city-main_XhujIcb.png	1	28	\N
22	images/news-1_KBdpVaL.png	5	19	\N
23	images/news-2_kH3rApT.png	6	19	\N
24	images/news-3_FfBzbID.png	7	19	\N
25	images/news-4_jpcbnoY.png	8	19	\N
19	images/big-main_SJu59vu.png	2	26	\N
20	images/reg-main_4ZyRIuK.png	1	25	\N
26	images/city-main_oFpg0Gu.png	1	25	\N
28	images/city-main_G4pQNwM.png	2	26	\N
29	images/reg-main_HZ377PG.png	2	26	\N
27	images/big-main_h9R46if.png	1	28	\N
30	images/reg-main_T9bJHV3.png	1	28	\N
31	images/big-main_M8oadIY.png	2	25	\N
32	images/reg-main_tQr9EIa.png	2	25	\N
33	images/city-main_C7ByMsl.png	2	25	\N
34	images/big-main_ytV99Du.png	3	25	\N
35	images/city-main_W7rOqyd.png	3	25	\N
36	images/reg-main_RpV3XkO.png	3	25	\N
37	images/big-main_SFfNBt1.png	2	28	\N
38	images/city-main_dYoWMJr.png	2	28	\N
39	images/reg-main_xzBPaMC.png	2	28	\N
40	images/big-main_uQqpssX.png	3	28	\N
41	images/city-main_HH3hQHw.png	3	28	\N
42	images/reg-main_Z1dv47I.png	3	28	\N
43	images/big-main_pZSCAnU.png	4	28	\N
44	images/reg-main_QMKSkPE.png	4	28	\N
45	images/city-main_ESEKUCP.png	4	28	\N
46	images/big-main_5BtHxqJ.png	5	28	\N
47	images/reg-main_a69xlzj.png	5	28	\N
48	images/city-main_eckwdej.png	5	28	\N
49	images/big-main_RcJxrQR.png	6	28	\N
50	images/city-main_Cm72fOt.png	6	28	\N
51	images/reg-main_9n0wDXh.png	6	28	\N
52	images/city-main_PJIXph9.png	7	28	\N
53	images/big-main_VHjtNLZ.png	7	28	\N
54	images/reg-main_ugo1KTU.png	7	28	\N
55	images/reg-main_2kv7Nng.png	8	28	\N
56	images/big-main_DH8RHuU.png	8	28	\N
57	images/city-main_OmPeNx8.png	8	28	\N
58	images/reg-main_3YNjy97.png	9	28	\N
59	images/city-main_nIFhU7D.png	9	28	\N
60	images/big-main_g1Qivew.png	9	28	\N
61	images/big-main_l1a1Toq.png	3	26	\N
62	images/city-main_ayV8ct0.png	3	26	\N
63	images/reg-main_2MrSYj5.png	3	26	\N
64	images/big-main_QYpNCmm.png	4	26	\N
65	images/city-main_HVOT6Ts.png	4	26	\N
66	images/big-main_kYgECGW.png	5	26	\N
67	images/reg-main_7z856VF.png	5	26	\N
68	images/big-main_0xTRz1F.png	6	26	\N
69	images/big-main_xMSYS8o.png	7	26	\N
70	images/city-main_QAU7WPg.png	7	26	\N
71	images/reg-main_qVBS4Od.png	7	26	\N
72	images/big-main_klPTc3x.png	8	26	\N
73	images/city-main_Uwl8NDt.png	8	26	\N
74	images/city-main_w05dOc6.png	9	26	\N
75	images/big-main_QAyGPty.png	10	26	\N
76	images/city-main_uWTjatd.png	10	26	\N
77	images/reg-main_c8uHYlW.png	10	26	\N
78	images/big-main_zUhKhB9.png	11	26	\N
79	images/blog1.png	9	19	\N
80	images/blog_1-1_YkqsBYP.png	10	19	\N
81	images/blog1_KAnfkbc.png	11	19	\N
82	images/blog_1-1_KKA6skr.png	12	19	\N
83	images/blog1_VbTz8GG.png	13	19	\N
84	images/blog_1-1_O5F1WdW.png	14	19	\N
85	images/blog1_1ZrzwjD.png	15	19	\N
86	images/blog_1-1_nzitnD0.png	16	19	\N
87	images/blog1_SquvylT.png	18	19	\N
88	images/blog_1-1_V5xkQ7c.png	17	19	\N
89	images/blog1_VsEiM9r.png	19	19	\N
90	images/blog_1-1_f20aXOc.png	20	19	\N
91	images/blog1_1qE7XKY.png	21	19	\N
92	images/blog_1-1_qzvaNMl.png	22	19	\N
93	images/blog1_HW4HB8E.png	23	19	\N
94	images/blog_1-1_nbY82xC.png	24	19	\N
95	images/blog1_EWfqFV5.png	25	19	\N
96	images/blog_1-1_k7Vtjlr.png	26	19	\N
97	images/blog_1-1_LE7LN7v.png	27	19	\N
98	images/blog1_sxHe9A3.png	28	19	\N
99	images/serf-1.png	1	37	\N
100	images/serf-2.png	1	37	\N
101	images/serf-3.png	1	37	\N
102	images/serf-4.png	1	37	\N
1	images/anex.png	1	15	http://anextour.com.ua/
2	images/coral.png	1	15	http://www.coraltravel.ua/
3	images/join.png	1	15	https://joinup.ua/
5	images/tez.png	1	15	https://www.tez-tour.com/
6	images/trg.png	1	15	https://www.tpg.ua/
\.
...
168	2018-09-04 06:30:17.75018+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-10", "fields": ["start"]}}]	21	1
169	2018-09-04 06:41:01.82532+00	15	Tour object (15)	2	[{"added": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-04"}}]	21	1
170	2018-09-04 06:41:11.526666+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-04", "fields": ["currency"]}}]	21	1
171	2018-09-04 06:41:19.936152+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-04", "fields": ["currency"]}}]	21	1
172	2018-09-04 06:45:54.850046+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-07", "fields": ["hot"]}}]	21	1
173	2018-09-04 06:48:23.025053+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-04", "fields": ["hot"]}}]	21	1
174	2018-09-04 06:59:42.247128+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-04", "fields": ["hot"]}}]	21	1
175	2018-09-04 07:00:03.113869+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-08", "fields": ["start"]}}, {"changed": {"name": "Tour Datepair", "object": "2018-09-05 \\u2014 2018-09-09", "fields": ["start", "hot"]}}, {"changed": {"name": "Tour Datepair", "object": "2018-09-06 \\u2014 2018-09-10", "fields": ["start", "end"]}}]	21	1
176	2018-09-04 07:09:51.627297+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-05 \\u2014 2018-09-09", "fields": ["hot"]}}]	21	1
177	2018-09-04 07:39:57.588597+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-09", "fields": ["start"]}}, {"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-17", "fields": ["start"]}}]	21	1
178	2018-09-04 07:40:46.51022+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-17", "fields": ["cost", "currency"]}}]	21	1
179	2018-09-04 07:41:03.000683+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-10", "fields": ["currency"]}}]	21	1
180	2018-09-04 07:41:35.477819+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-10", "fields": ["currency"]}}]	21	1
181	2018-09-04 07:41:49.437866+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-10", "fields": ["currency"]}}]	21	1
182	2018-09-04 07:44:12.102092+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-03 \\u2014 2018-09-08", "fields": ["start", "end"]}}]	21	1
183	2018-09-04 07:50:43.121839+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-03 \\u2014 2018-09-11", "fields": ["end"]}}, {"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-15", "fields": ["end"]}}]	21	1
184	2018-09-04 07:51:41.577512+00	14	Tour object (14)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-04 \\u2014 2018-09-10", "fields": ["hot"]}}]	21	1
185	2018-09-04 07:56:50.611895+00	15	Tour object (15)	2	[{"changed": {"name": "Tour Datepair", "object": "2018-09-05 \\u2014 2018-09-12", "fields": ["start", "end"]}}, {"changed": {"name": "Tour Datepair", "object": "2018-09-05 \\u2014 2018-09-12", "fields": ["end"]}}, {"changed": {"name": "Tour Datepair", "object": "2018-09-06 \\u2014 2018-09-12", "fields": ["end"]}}]	21	1
186	2018-09-04 09:35:17.34476+00	14	Tour object (14)	2	[{"changed": {"fields": ["country", "resort", "hotel"]}}]	21	1
187	2018-09-04 09:35:38.71167+00	14	Tour object (14)	2	[]	21	1
188	2018-09-04 11:12:52.355854+00	14	Tour object (14)	2	[{"changed": {"fields": ["hotel"]}}]	21	1
189	2018-09-04 12:01:06.062878+00	2	Египет	2	[{"changed": {"fields": ["holidays"]}}]	25	1
190	2018-09-04 12:20:52.005803+00	15	Tour object (15)	2	[{"changed": {"fields": ["country"]}}]	21	1
191	2018-09-04 12:23:12.190534+00	15	Tour object (15)	2	[]	21	1
192	2018-09-04 12:26:49.990584+00	1	AboutSettings object (1)	2	[{"changed": {"fields": ["image", "title", "column1_image", "column1_title", "column1_body", "column2_image", "column2_title", "column2_body", "column3_image", "column3_title", "column3_body", "column4_image", "column4_title", "column4_body", "body"]}}, {"added": {"name": "image", "object": "Image object (99)"}}, {"added": {"name": "image", "object": "Image object (100)"}}, {"added": {"name": "image", "object": "Image object (101)"}}, {"added": {"name": "image", "object": "Image object (102)"}}]	37	1
193	2018-09-04 12:34:44.602575+00	4	Comment object (4)	2	[{"changed": {"fields": ["type"]}}]	18	1
194	2018-09-04 12:35:51.055205+00	5	Comment object (5)	1	[{"added": {}}]	18	1
195	2018-09-04 12:43:46.890848+00	2	EmailDispatch object (2)	3		34	1
196	2018-09-04 12:43:46.918421+00	1	EmailDispatch object (1)	3		34	1
197	2018-09-04 12:50:00.176676+00	1	DocumentsSettings object (1)	1	[{"added": {}}]	38	1
198	2018-09-04 12:52:12.741641+00	1	DocumentsSettings object (1)	2	[{"changed": {"fields": ["passport", "visa"]}}]	38	1
199	2018-09-04 13:15:20.439972+00	1	IndexSettings object (1)	2	[{"changed": {"name": "image", "object": "Image object (1)", "fields": ["link"]}}, {"changed": {"name": "image", "object": "Image object (2)", "fields": ["link"]}}, {"changed": {"name": "image", "object": "Image object (3)", "fields": ["link"]}}, {"changed": {"name": "image", "object": "Image object (4)", "fields": ["link"]}}, {"changed": {"name": "image", "object": "Image object (5)", "fields": ["link"]}}, {"changed": {"name": "image", "object": "Image object (6)", "fields": ["link"]}}]	15	1
\.
...
37	core	aboutsettings
38	core	documentssettings
\.
...
42	tours	0006_auto_20180904_0640	2018-09-04 06:40:41.324629+00
43	tours	0007_tourdatepair_hot	2018-09-04 06:42:32.952861+00
44	tours	0008_auto_20180904_0918	2018-09-04 09:18:33.013063+00
45	core	0010_aboutsettings	2018-09-04 12:23:38.082948+00
46	core	0011_auto_20180904_1234	2018-09-04 12:34:26.428139+00
47	core	0012_documentssettings	2018-09-04 12:48:06.853987+00
48	core	0013_image_link	2018-09-04 13:13:28.008269+00
\.
...
z5b3lq7znyziyhy33j8mkgqiugya39s4	N2I5MTE4ODE1NzRkMTI4NjAxMjUzYWNkNjU5YWU3YzU4MzllNzg2Yjp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiI1MjM2ZTUxOTY0Mjk3Y2JjOTgzY2Q3YmFiZDFhNzVhYTI3OGQyNGEzIn0=	2018-09-18 12:11:10.990276+00
eedco1swndreqg20u694m3o7pbf8spla	YjUxY2NhNmRhZjZkZjg2ODg0YzZmYjE4M2YyMDhmZGU1YTUwMzQ1ZDp7ImFydGljbGUtMTkiOnRydWV9	2018-09-18 13:04:01.950742+00
88mtr7koi9ec06km80wlsqc6ov7p3lzp		2018-09-18 13:30:28.595774+00
\.
...
13	2018-09-04 11:55:08.610666+00	2018-09-04 11:55:09.362669+00	Новая заявка на звонок!	<p>Nikolay: First Name<br />\r\n+380665005001: Phone Number<br />\r\nhttp://127.0.0.1:8535/: Sent From Link<br />\r\n4 сентября 2018 г. 11:55: Date</p>		floydya@ukr.net	xfloydya@gmail.com	CALL	sent	\N
14	2018-09-04 12:57:08.737022+00	2018-09-04 12:57:09.816212+00	Новая заявка на звонок!	<p>Nikolay: First Name<br />\r\n+380665005001: Phone Number<br />\r\nhttp://127.0.0.1:8535/: Sent From Link<br />\r\n4 сентября 2018 г. 12:57: Date</p>		floydya@ukr.net	xfloydya@gmail.com	CALL	sent	\N
\.
...
8	Nikolay	+380665005001	f	http://127.0.0.1:8535/	2018-09-04 11:55:08.465613+00
9	Nikolay	+380665005001	f	http://127.0.0.1:8535/	2018-09-04 12:57:08.583517+00
\.
...
COPY tours_tour (id, sending_from, duration_days, duration_nights, stars, hotel_id, type_id, country_id, resort_id) FROM stdin;
5	Киев	3	3	1	2	1	2	2
6	Киев	14	14	5	2	1	2	2
7	Киев	5	5	4	9	6	2	2
8	Харьков	14	14	5	3	7	2	2
9	Киев	6	6	2	3	4	2	2
10	Киев	14	14	5	7	5	2	2
11	Харьков	12	12	3	8	7	2	2
13	Киев	3	3	2	11	2	2	2
2	Киев	7	7	4	2	1	2	2
3	Киев	5	5	2	2	1	2	2
4	Киев	7	7	5	2	1	2	2
12	Киев	7	7	5	6	9	2	2
14	Киев	3	3	1	4	6	1	1
15	Киев	7	7	4	8	1	1	2
\.
...
COPY tours_tourdatepair (id, start, "end", cost, tour_id, uah_cost, currency, hot) FROM stdin;
5	2018-09-03	2018-09-10	125	2	3547	d	f
8	2018-09-03	2018-09-10	512	5	14529	d	f
9	2018-09-03	2018-09-10	154	6	4370	d	f
10	2018-09-03	2018-09-10	567	7	16090	d	f
11	2018-09-03	2018-09-10	452	8	12826	d	f
12	2018-09-03	2018-09-10	764	9	21681	d	f
13	2018-09-03	2018-09-10	999	10	28349	d	f
14	2018-09-03	2018-09-10	111	11	3149	d	f
15	2018-09-03	2018-09-10	96	12	2724	d	f
16	2018-09-03	2018-09-10	242	13	6867	d	f
18	2018-09-01	2018-09-08	112	2	3178	d	f
19	2018-09-03	2018-09-09	28	2	794	d	f
6	2018-09-01	2018-09-10	256	3	7264	d	f
7	2018-09-01	2018-09-10	219	4	6214	d	f
21	2018-09-01	2018-09-08	1	12	28	d	f
4	2018-09-04	2018-09-17	2560	14	2560	u	f
3	2018-09-03	2018-09-11	128	14	3632	d	t
1	2018-09-04	2018-09-15	350	14	9932	d	f
2	2018-09-04	2018-09-10	425	14	14001	e	t
17	2018-09-05	2018-09-12	115	15	3263	d	f
20	2018-09-05	2018-09-12	116	15	3291	d	f
22	2018-09-06	2018-09-12	100	15	3294	e	f
\.
...
--
-- Name: core_aboutsettings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('core_aboutsettings_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_comment_id_seq', 5, true);


--
-- Name: core_documentssettings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('core_documentssettings_id_seq', 1, false);
...
SELECT pg_catalog.setval('core_emaildispatch_id_seq', 4, true);
...
SELECT pg_catalog.setval('core_image_id_seq', 102, true);
...
SELECT pg_catalog.setval('django_admin_log_id_seq', 199, true);
...
SELECT pg_catalog.setval('postie_letter_id_seq', 14, true);
...
SELECT pg_catalog.setval('reports_call_id_seq', 9, true);
...
SELECT pg_catalog.setval('tours_tourdatepair_id_seq', 22, true);
...
--
-- Name: core_aboutsettings core_aboutsettings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY core_aboutsettings
    ADD CONSTRAINT core_aboutsettings_pkey PRIMARY KEY (id);
...
--
-- Name: core_documentssettings core_documentssettings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY core_documentssettings
    ADD CONSTRAINT core_documentssettings_pkey PRIMARY KEY (id);
...
CREATE INDEX tours_tour_country_id_38ee2458 ON tours_tour USING btree (country_id);
...
--
-- Name: tours_tour_resort_id_08f8eba1; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tours_tour_resort_id_08f8eba1 ON tours_tour USING btree (resort_id);
...
--
-- Name: tours_tour tours_tour_country_id_38ee2458_fk_locations_country_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY tours_tour
    ADD CONSTRAINT tours_tour_country_id_38ee2458_fk_locations_country_id FOREIGN KEY (country_id) REFERENCES locations_country(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: tours_tour tours_tour_resort_id_08f8eba1_fk_locations_resort_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY tours_tour
    ADD CONSTRAINT tours_tour_resort_id_08f8eba1_fk_locations_resort_id FOREIGN KEY (resort_id) REFERENCES locations_resort(id) DEFERRABLE INITIALLY DEFERRED;
